...
namespace NpoMash.Erm.Hrm.Tests.Win
{
    ...
    public partial class NpoErmHrmTestsWinApplication : WinApplication
    { // http://documentation.devexpress.com/#Xaf/DevExpressExpressAppWinWinApplicationMembersTopicAll
        public NpoErmHrmTestsWinApplication()
        {
            InitializeComponent();
        ...
        private void TestsWindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e)
        {

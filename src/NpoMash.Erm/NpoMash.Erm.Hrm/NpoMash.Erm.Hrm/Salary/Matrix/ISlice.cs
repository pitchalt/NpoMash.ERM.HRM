...
namespace NpoMash.Erm.Hrm.Salary.Matrix {
    ...
    public interface ISlice<Td, Ts, Tm, Tc, Tr, Te, Tv> :
        M.ISlice<Td, Ts, DepartmentGroupDep, Tm, Tc, Department, Tr, fmCOrder, Te, Tv>, 
    ...
    {
        DepartmentGroupDep DepartmentGroup { get; }
    }
